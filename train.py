...
def main():
    ...
    for epoch in range(epochs):
        ...
        if valid_epoch_acc>best_accuracy:
            ...
            save_model(epoch, model, optimizer, criterion,is_best=True)
        save_model(epoch, model, optimizer, criterion, False)
    ...
    save_model(epochs, model, optimizer, criterion, True)
